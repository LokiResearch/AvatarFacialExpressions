...
public class RayMoji_ExprSelection : MonoBehaviour
{
    ...
    {
        Expression.GRINNING,                        // expé
        Expression.SMILING_WITH_SMILING_EYES,       // expé
        Expression.ROLLING_ON_THE_FLOOR_LAUGHING,
        Expression.SLIGHTLY_SMILING,                // expé
        Expression.WINKING,                         // commun
        Expression.FLUSHED,
        Expression.SMILING_WITH_HEART_EYES,         // expé
        Expression.KISSING,
        Expression.WITH_TONGUE,
        Expression.ZANY,
        Expression.THINKING,                        // expé
        Expression.SMIRKING,                        // commun
        Expression.PENSIVE,
        Expression.GRIMACING,
        Expression.NAUSEATED,                       // commun
        Expression.HOT,
        Expression.COLD,
        Expression.FROWNING,                        // expé
        Expression.WITH_OPEN_MOUTH,                 // expé
        Expression.PLEADING,
        Expression.DOWNCAST_WITH_SWEAT,             // commun
        Expression.LOUDLY_CRYING,
        Expression.WEARY,
        Expression.ANGRY                            // expé
    };
